...
<div class="card">
  <div class="card-content">
    <p class="caption mb-0">Anda dapat menambah data user.</p>
  </div>
</div>
<!-- Input Fields -->
<div class="row">
    ...
    <div id="input-fields" class="card card-tabs">
      <div class="card-content">
        ...
        <div id="view-input-fields">
          <div class="row">
            <div class="col s12">
              <form method="POST" action='{{route('admin.user.store')}}' class="row">
                @csrf
                <div class="col s12">
                ...
                <div class="col s12">
                  <div class="input-field col s12">
                    <select name="store" id="store" class="select2 browser-default">
